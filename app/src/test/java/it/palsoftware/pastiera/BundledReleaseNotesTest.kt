...
class BundledReleaseNotesTest {
    ...
    fun forkNotesAreBundled() {
        ...
        assertTrue(notes.title.startsWith("Pastiera Flux"))
    ...
    fun forkVersionsReadAsADate() {
        ...
        assertEquals("Pastiera Flux 0.86", bundledReleaseNotes(RuntimeEnvironment.getApplication(), "0.86-flux.202609260416")?.title)
    }
