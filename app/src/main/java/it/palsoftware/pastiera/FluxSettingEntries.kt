...
internal fun fluxSettingEntries(): List<SettingEntry> {
    ...
    return listOf(
        ...
        SettingEntry("flux_emoji.sym_sticky", R.string.sym_sticky_title,
            summaryRes = R.string.sym_sticky_description, route = emoji),
        SettingEntry("flux_emoji.emoji_sticky", R.string.emoji_sticky_title,
            summaryRes = R.string.emoji_sticky_description, route = emoji),
        SettingEntry("flux_emoji.emoji_led", R.string.emoji_led_title,
            summaryRes = R.string.emoji_led_description, route = emoji),
