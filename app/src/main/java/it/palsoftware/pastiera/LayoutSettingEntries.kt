...
internal fun layoutSettingEntries(): List<SettingEntry> = listOf(
    ...
    SettingEntry(SettingLinkIds.AUTO_CORRECTION_SUGGESTION_KEYS, R.string.suggestion_keys_title,
        summaryRes = R.string.suggestion_keys_ctrl_shift_qwe,
    ...
    SettingEntry("led_colors.sym", R.string.led_colors_sym, route = SettingRoute(SettingsDestination.LedColors),
        availabilityCheck = { SettingsManager.getLedIndividualColorsEnabled(it) }, unavailableFallbackId = SettingLinkIds.LED_INDIVIDUAL_COLORS),
    SettingEntry("led_colors.emoji", R.string.led_colors_emoji, route = SettingRoute(SettingsDestination.LedColors),
        availabilityCheck = { SettingsManager.getLedIndividualColorsEnabled(it) && SettingsManager.getEmojiKeyLedEnabled(it) },
        unavailableFallbackId = SettingLinkIds.LED_INDIVIDUAL_COLORS),
