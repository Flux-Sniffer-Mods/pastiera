...
internal object BackupPreferenceContract {
    private val pastieraPrefsSchema = PreferenceFileSchema(
        ...
        fixedKeys = mapOf(
            ...
            "trackpad_swipe_down_deletes_word" to PreferenceValueType.BOOLEAN,
            "sym_sticky_tap" to PreferenceValueType.BOOLEAN,
            ...
            "emoji_sticky_tap" to PreferenceValueType.BOOLEAN,
            "emoji_key_led" to PreferenceValueType.BOOLEAN,
            ...
            "hidden_app_standard_modifiers" to PreferenceValueType.BOOLEAN,
            "emoji_search_enter_picks" to PreferenceValueType.BOOLEAN,
            "symbol_search_enter_picks" to PreferenceValueType.BOOLEAN,
            ...
            "gif_focus_search" to PreferenceValueType.BOOLEAN,
            "emoji_layer_type_to_search" to PreferenceValueType.BOOLEAN,
            "symbols_type_to_search" to PreferenceValueType.BOOLEAN,
            "gifs_enabled" to PreferenceValueType.BOOLEAN,
            "smart_alt_off_after_opening" to PreferenceValueType.BOOLEAN,
            "smart_ctrl_off_after_shortcut" to PreferenceValueType.BOOLEAN,
            "developer_options_enabled" to PreferenceValueType.BOOLEAN,
            ...
            "led_color_shift" to PreferenceValueType.INT,
            "led_color_ctrl" to PreferenceValueType.INT,
            ...
            "app_shortcuts_suggestions" to PreferenceValueType.BOOLEAN,
            "app_shortcuts_apps" to PreferenceValueType.STRING,
            ...
            "hidden_keyboard_apps_leds" to PreferenceValueType.STRING,
            "hidden_keyboard_apps_panels" to PreferenceValueType.STRING,
